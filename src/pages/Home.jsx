      ...
      {notes.map((note) =>(
        ...
        <div  className='note'>
          ...
          <div className='created-at'>
             <p> {formatDate(note.createdAt)} { deletingID === note._id ? (<Loader className='loader-icon' />) : (<span className='trash-icon' onClick={()=>{deleteNote(note._id)}}> <Trash size={20} color='red'/></span> ) }</p> 
          </div>
